...
- Spell selection matches by **level and school code**, not by name — that part is already language-independent.
...
- Los conjuros se eligen por **nivel y código de escuela**, no por nombre — esa parte ya es independiente del idioma.
